...
public class SequenceFileReader<KeyType extends WritableComparable,ValueType extends Writable> {
  ...
  public SequenceFileReader(FileSystem fileSystem,
      Configuration conf,
  ...
  public void readAndSpill() throws IOException { 
    ...
    for (Path sequenceFilePath : _inputSegments) { 
      ...
      try { 
        ...
        //LOG.info("Read and Spill of File:" + sequenceFilePath +" took:" + (System.currentTimeMillis() - individualReadTimeStart));
      }
      finally { 
    ...
    //LOG.info("Cumilative Read and Spill took:" + (System.currentTimeMillis() - cumilativeReadTimeStart) + " Spilled RecordCount:" + _recordCount);
  }
}
