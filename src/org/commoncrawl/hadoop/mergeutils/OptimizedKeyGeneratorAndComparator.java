...
public abstract class OptimizedKeyGeneratorAndComparator<KeyType extends Writable,ValueType extends Writable> {
	...
	/**
	 * Given a key object and a value object, produce an optimized key data structure 
	 * 
	 * @param key   - the key value associated with this object 
	 * @param value - the value associated with this object 
	 * @param optimizedKeyOut - the optimized key value out
	 * @throws IOException
	 */
  public abstract void generateOptimizedKeyForPair(KeyType key,ValueType value,OptimizedKey optimizedKeyOut) throws IOException;
  ...
  /**
   * compare two optimized key values (previously emitted as buffers by generate method)
   * @param key1Data
   * @param key1Offset
   * @param key1Length
   * @param key2Data
